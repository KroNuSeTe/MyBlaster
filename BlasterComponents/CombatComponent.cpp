...
#include "MyBlaster/Character/BlasterAnimInstance.h"
...
void UCombatComponent::AttachActorToLeftHand(AActor* ActorToAttach)
{
	...
	else if (EquippedWeapon->GetWeaponType() == EWeaponType::EWT_SubmachineGun)
	{
...
void UCombatComponent::ServerLaunchGrenade_Implementation(const FVector_NetQuantize& Target)
{
	if (Character && GrenadeClass && Character->GetAttachedGrenade())
	{
		...
		if (World)
		{
			GrenadeSpawn = World->SpawnActor<AProjectile>(
				GrenadeClass,
				StartingLocation,
				ToTarget.Rotation(),
				SpawnParams
...
void UCombatComponent::InterpFOV(float DeltaTime)
{
	...
	{
		CurrentFOV = FMath::FInterpTo(CurrentFOV, DefaultFOV, DeltaTime, ZoomOutInterpSpeed);
	}
